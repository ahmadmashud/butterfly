...
<body>
    ...
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td>@convert($data->amount_harga_paket)</td>
        </tr>
        <tr>
            <td colspan="4">
                <hr width="100%" style="border-top: 3px line #bbb;" />
        ...
        <tr>
            ...
            <td><b>@convert( $data->jumlah_sesi*$data->amount_harga_paket )</b>
        
            <hr width="100%" style="border-top: 3px line #bbb;" /></td>
        </tr>
        <tr>
            <td colspan="4">
                <hr width="100%" style="border-top: 3px line #bbb;" />
        ...
        <tr>
            ...
            <td></td>
            <td></td>
            <td><b>@convert( $data->amount_harga_produk )</b>
            <hr width="100%" style="border-top: 3px line #bbb;" />
            </td>
        </tr>
        <tr>
            <td colspan="3"><b>Sub Total</b></td>
            <td><b>@convert( $data->amount_harga_produk + ($data->jumlah_sesi*$data->amount_harga_paket) )</b></td>
        </tr>
        <tr>
            <td colspan="4">
                <hr width="100%" style="border-top: 3px line #bbb;" />
        ...
        <tr>
            <td></td>
            <td >Room Disc</td>
            <td>@convert( $data->amount_total_discount )</td>
            <td></td>
        </tr>
        <tr>
            <td></td>
        ...
        <tr>
            ...
            <td><b>@convert( $data->amount_total_service_charge )</b></td>
        </tr>
        <tr>
            <td colspan="4">
                <hr width="100%" style="border-top: 3px line #bbb;" />
        ...
        <tr>
            ...
            <td><b>@convert( $data->amount_grand_total )</b>
