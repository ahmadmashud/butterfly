            ...
            <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $value->code }}</td>
                        <td>{{ $value->no }}</td>
                        <td><input disabled type="checkbox" {{ $value->is_used ? "" : "checked" }} data-toggle="toggle" data-on="Kosong" 
                        data-off="Dipakai" data-onstyle="success" data-offstyle="danger" data-size="sm" data-width="100" ></td>
                        ...
                        <td>
                            <form action="/lokers/{{ $value->id }}/delete" method="post">
                                @csrf
...
<script src="{{ asset('assets/js/loker/loker.js') }}" type="text/javascript"> </script>
@endsection