            ...
            <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="/foodDrinks/{{ $value->id }}/delete" method="post">
                                @csrf
...
<!-- MODAL -->
@include('foodDrink._add')
@include('foodDrink._edit')
@endsection


@section('extra_javascript')
<script src="{{ asset('assets/js/foodDrink/foodDrink.js') }}" type="text/javascript"> </script>
@endsection