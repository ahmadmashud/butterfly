            ...
            <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>@convert($value->km_supplier)</td>
                        ...
                        <td>
                            <form action="/packageRooms/{{ $value->id }}/delete" method="post">
                                @csrf
...
<!-- MODAL -->
@include('packageRoom._add')
@include('packageRoom._edit')
@endsection


@section('extra_javascript')
<script src="{{ asset('assets/js/packageRoom/packageRoom.js') }}" type="text/javascript"> </script>
@endsection