<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form class="form-horizontal" method="post" action="/rooms/edit">
              ...
              <div class="ibox">
                <div class="ibox-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="checkbox" checked="true" name="is_used" data-toggle="toggle" data-on="Kosong" data-off="Dipakai" data-onstyle="success" data-offstyle="danger" data-size="sm" data-width="100">
                  </div>
                  <div class="form-group">
